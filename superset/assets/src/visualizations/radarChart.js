...
==> Source: http://bl.ocks.org/nbremer/21746a9668ffdf6d8242

*/

function RadarChart(id, keys, data, options) {
    const cfg = {
        ...
        labelFactor: 1.25, // How much farther than the radius of the outer circle should
        // the labels be placed
